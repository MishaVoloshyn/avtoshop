...
export const FAQGeneral = () => {
    return (
        <section className="my-5 faq" id="faq">
            <div className="container my-3">
                <h2 className="dm-sans-bold text-center mb-3">General</h2>
                        ...
                        <div className="faq-list">
                            <ul>
                                <li data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div id="faq-list-1" className="collapse" data-bs-parent=".faq-list">
                                        <p className="ft-18">
                                            ...
                                            Metus, scelerisque volutpat nec sit vel donec. Sagittis, id volutpat erat vel.                                        </p>
                                    </div>
                                </li>
                                ...
                                <li data-aos="fade-up" data-aos-delay="300">
                                    <a data-bs-toggle="collapse" href="#faq-list-3" className="collapsed ft-18 dm-sans-medium line-120">
                                        Can I save my favorite cars to a list I can view later?                                        <i className="bx bx-plus icon-show"></i>
                                        <i className="bx bx-minus icon-close"></i>
                                    </a>
                                ...
                                <li data-aos="fade-up" data-aos-delay="400">
                                    <a data-bs-toggle="collapse" href="#faq-list-4" className="collapsed ft-18 dm-sans-medium line-120">
                                ...
                                <li data-aos="fade-up" data-aos-delay="500">
                                    <a data-bs-toggle="collapse" href="#faq-list-5" className="collapsed ft-18 dm-sans-medium line-120">
