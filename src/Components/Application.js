            ...
            <div className="row">
                <div className="col-12" style={{
                    ...
                    <div className="row py-5">
                        <div className="col-6">
                            <p className="dm-sans-bold ft-40 overlay-text text-capitalize">Shop used cars, whether
                                you're
                    ...
                    <div className="row">
                        <div className="col-6">
                    <p>Download our app to save cars and create alerts, scan window stickers on our lot for more
                        details,
